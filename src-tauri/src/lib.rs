...
pub fn run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            trade_log::add_trade,
            stats::get_arbitration_runs,
            stats::delete_arbitration_run,
            stats::export_stats,
            stats::import_stats,
            ...
            inventory_state::get_saved_consumed_suits,
            ...
            relic_pick::set_arbitration_overlay_enabled,
            ...
            relic_pick::test_arbitration_overlay,
