...
pub(crate) static RIVEN_DB: std::sync::RwLock<Option<HashMap<String, RivenEntry>>> =
...
#[tauri::command]
pub(crate) async fn ocr_riven_screen(state: State<'_, AppState>) -> Result<serde_json::Value, String> {
